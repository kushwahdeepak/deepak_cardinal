...
module Parser
  class EmailProcessor
    include Parser::Processable
    attr_accessor :attachment, :resume_text, :email_plain_text, :candidate_email, :parsed_email_json, :linkedin_job_id, :candidate_name, :source
    ...
    def process?
      ...
      begin
        ...
        @linkedin_job_id = @parsed_email_json[:contract_id]
